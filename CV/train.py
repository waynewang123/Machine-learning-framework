...
if __name__ == "__main__":
	#locate of train,csv and train_png folder
	data_path  = 'siim_png'
	#cuda/cpu device
	device = 'cuda'
	...
	#fetch out model, we will sue both pretrained and non-pretrained weights
	...
	valid_dataset = dataset.ClassificationDataset( image_paths=valid_images, targets=valid_targets,
	resize=(227, 227),
	augmentations=aug, )
